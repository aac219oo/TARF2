      ...
      <div class="searchForm">
        ...
        <div class="searchSelectBottom">
          ...
          <el-form-item label="審查案件查詢(限閱)">
            <el-select v-model="form.reading" placeholder="請選擇審查案件" :size="size">
...
const tables = [{
          ...
          labelNumber: 'CF620',
          title: '檢送台北捷運環狀線北環段及南環段機電系統、自動收費系統及軌道工程採購案CF620/CF627/CF621標行車監控子系統「系統架構說明」A版，詳細如附件，請查照',
          ...
          labelNumber: 'CF624G',
          title: '檢送「台北都會區大眾捷運系統環狀線北環段CF624G施工邊拳北環段及南環段之間控與建築物管系統工程111年六月施工日誌」正本一式乙份，詳細如附件，請查照',
          ...
          labelNumber: 'CF680C',
          title: '有關貴所111年6月24日稽查工地安位環保缺失改善，本所已改善完成，詳如說明，請查照',
          apply_date: '111.07.01',
          ...
          labelNumber: 'CF680C',
          title: '檢送本工程-台北都會區大眾捷運系統環狀線北環段CF680C區標工程-CF680C標補工地質調查計畫書(核定0版)，一式2份，如附件，請准予備查',
          apply_date: '111.07.03',
