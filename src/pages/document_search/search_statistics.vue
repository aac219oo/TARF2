  ...
  <el-container>
      ...
      <el-row>
        <el-tabs :tab-position="tabPosition" style="height: auto; width: 100%" class="demo-tabs">
          ...
          <el-tab-pane label="各標送審文件統計">
                ...
                <div class="container_left">
                  <div class="input_position">
                    <el-form-item class="datepicker" label="統計月份">
                      <el-date-picker v-model="value" type="daterange" unlink-panels range-separator="~"
                        start-placeholder="請選擇日期" end-placeholder="請選擇日期" :size="size" />
                    </el-form-item>
                    <el-form-item class="button-items">
                      <div class="button-items-search">
                        <el-button @click="onSubmit"><img src="../../assets/icon01.png"
            ...
            <el-table class="tableForm" :data="tableData1" border stripe show-summary :summary-method="getSummaries"
              style="width: 100%" :header-cell-style="{
                background: '#ebf4f9',
                color: '#000',
                textAlign: 'center',
              }">
              <el-table-column prop="labelNumber"
    ...
    <el-table-column prop="Xinyi" label="信義線" :resizable="false"/> -->
          ...
          <el-tab-pane label="單位審查案件數量統計">
            ...
            <el-table class="tableForm" :data="tableData2" border stripe show-summary :summary-method="getSummaries"
              style="width: 100%" :header-cell-style="{
                background: '#ebf4f9',
                color: '#000',
                textAlign: 'center',
          ...
          <el-tab-pane label="審查案件辦理情形統計">
            ...
            <el-table class="tableForm tableSearchCondition" :data="tableData3" row-key="id" border stripe show-summary
              :summary-method="getSummaries" style="width: 100%" :header-cell-style="{
                background: '#ebf4f9',
                color: '#000',
                textAlign: 'center',
              }">
          ...
          <el-tab-pane label="主辦單位審查文件數量統計">
            ...
            <el-table class="tableForm" :data="tableData4" row-key="id" border stripe show-summary
              :summary-method="getSummaries" style="width: 100%" :header-cell-style="{
                background: '#ebf4f9',
                color: '#000',
                textAlign: 'center',
...
const onSubmit = () => {
  ...
  console.log(dayjs(date1).format("YYYY-MM-DD") + ";" + dayjs(date2).format("YYYY-MM-DD"))
}
