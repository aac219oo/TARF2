...
<template>
    ...
    @select="handleSelect"
  >
    <el-menu-item index="6"><a href="../access_setting/index.html">權限設定</a></el-menu-item>
    <el-menu-item index="1"><a href="../individual_words/index.html">個人使用詞彙</a></el-menu-item>
    <el-menu-item index="2"><a href="../item_codes/index.html">送審項目代碼</a></el-menu-item>
    <el-menu-item index="3"><a href="../resualt_codes/index.html">送審結果代碼</a></el-menu-item>
    <el-menu-item index="4"><a href="../condition_codes/index.html">案件狀態代碼</a></el-menu-item>
    <el-menu-item index="5"><a href="../com_using_right/index.html">廠商使用權限</a></el-menu-item>
  </el-menu>
